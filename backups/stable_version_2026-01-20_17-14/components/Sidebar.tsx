    ...
    `}>
                ...
                <div className="h-14 flex items-center px-4 border-b border-[#1E293B] justify-between">
                    <div className="flex items-center gap-3">
                        <div className={`w-6 h-6 rounded flex items-center justify-center text-white text-[10px] font-bold shadow-lg ${isEnterpriseMode ? 'bg-indigo-600 shadow-indigo-500/20' : 'bg-[#3A57E8]'}`}>
                            {isEnterpriseMode ? 'EP' : 'CO'}
                        </div>
                        <span className="text-sm font-semibold text-white tracking-tight">
                            {isEnterpriseMode ? 'COO Enterprise' : 'COO/CFO Box'}
                        </span>
                    </div>
