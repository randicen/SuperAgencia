...
const UserProfileMenu: React.FC = () => {
    ...
    const handleSafeLogout = async () => {
        ...
        ['coo_spaces', 'coo_last_local_mod', 'coo_last_sync_fingerprint', 'coo_last_cloud_mod', 'coo_has_unsynced_local', 'coo_has_unsynced_local_v2'].forEach(k => localStorage.removeItem(k));
